...
//$disciplina = $_POST['disciplina_name'];
//setcookie('disciplina_name', $disciplina);
...
//if ($disciplina == 'Математика') { // формирование переменной $sql_disciplina(для последующего запроса в БД по нужному)
//    $sql_disciplina = 'disciplina_1';
//    setcookie('sql_disciplina',$sql_disciplina);
//    } if ($disciplina == 'Русский язык') {
//        $sql_disciplina = 'disciplina_2';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }if ($disciplina == 'Физика') {
//        $sql_disciplina = 'disciplina_3';
//        setcookie('sql_disciplina',$sql_disciplina);
//    } if ($disciplina == 'Литература') {
//        $sql_disciplina = 'disciplina_4';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }if ($disciplina == 'Черчение') {
//        $sql_disciplina = 'disciplina_5';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }if ($disciplina == 'Физкультура') {
//        $sql_disciplina = 'disciplina_6';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }if ($disciplina == 'Биология') {
//        $sql_disciplina = 'disciplina_7';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }if ($disciplina == 'Химия') {$sql_disciplina = 'disciplina_8';setcookie('sql_disciplina',$sql_disciplina);}if ($disciplina == 'История') {
//        $sql_disciplina = 'disciplina_9';
//        setcookie('sql_disciplina',$sql_disciplina);}if ($disciplina == 'Технология') {
//        $sql_disciplina = 'disciplina_10';
//        setcookie('sql_disciplina',$sql_disciplina);
//    }
//
